...
class __TwigTemplate_f542b34b1ffb414157a01728fbc08acd extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1 class=\"text-2xl font-bold mb-4\">Bienvenue sur Mini-Réseau !</h1>
    ...
    ";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 8, $this->source); })()), "user", [], "any", false, false, false, 8)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 11
                yield "                ";
                yield from $this->load("partials/_card.html.twig", 11)->unwrap()->yield(CoreExtension::merge($context, ["message" => $context["message"]]));
                // line 12
                yield "            ";
    ...
    ";
            ...
            // line 17
            yield "        <p>Vous devez être connecté pour voir les messages.</p>
        <a href=\"";
            // line 18
    ...
    {
        return array (  157 => 18,  154 => 17,  150 => 15,  143 => 13,  130 => 12,  127 => 11,  109 => 10,  106 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <h1 class=\"text-2xl font-bold mb-4\">Bienvenue sur Mini-Réseau !</h1>
    ...
    {% else %}
        <p>Vous devez être connecté pour voir les messages.</p>
