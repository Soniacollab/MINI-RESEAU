...
class __TwigTemplate_3e07bcf3809fa59ca68e193db1be934b extends Template
{
    ...
    <div class=\"mt-3 flex gap-3\">
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12) && (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12) == CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 12, $this->source); })()), "author", [], "any", false, false, false, 12)))) {
            // line 13
            yield "            <a href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("message_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 13, $this->source); })()), "id", [], "any", false, false, false, 13)]), "html", null, true);
            yield "\" class=\"text-yellow-500 hover:underline\">Modifier</a>
            <a href=\"";
            // line 14
...
";
    ...
    {
        return array (  93 => 16,  88 => 14,  83 => 13,  81 => 12,  76 => 10,  66 => 7,  62 => 6,  59 => 5,  53 => 3,  51 => 2,  48 => 1,);
    }
    ...
    <div class=\"mt-3 flex gap-3\">
        ...
        {% if app.user and app.user == message.author %}
            <a href=\"{{ path('message_edit', {'id': message.id}) }}\" class=\"text-yellow-500 hover:underline\">Modifier</a>
            <a href=\"{{ path('message_delete', {'id': message.id}) }}\" class=\"text-red-500 hover:underline\">Supprimer</a>
        {% endif %}
    </div>
</div>
", "partials/_card.html.twig", "/var/www/html/templates/partials/_card.html.twig");
    }
}
